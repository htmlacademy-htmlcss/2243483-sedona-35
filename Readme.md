...
- Студент: [Максим Львов](https://up.htmlacademy.ru/htmlcss/35/user/2243483).
- Наставник: `https://htmlacademy.ru/profile/id1217273`.
...
[Откройте мастер-репозиторий](https://github.com/htmlacademy-htmlcss/2243483-sedona-35) и нажмите кнопку «Fork» в правом верхнем углу. Репозиторий из Академии скопируется в ваш аккаунт.
